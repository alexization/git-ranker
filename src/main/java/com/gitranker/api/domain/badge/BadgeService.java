...
public class BadgeService {
    ...
    private static final String FONT_IMPORT_CSS = "@import url('https://fonts.googleapis.com/css2?family=Chakra+Petch:wght@700&family=JetBrains+Mono:wght@400;700&family=Noto+Sans+KR:wght@400;500;700&family=Outfit:wght@400;500;700;900&display=swap');";

    // [Font Stack] 외부 폰트 실패 시 시스템 폰트 fallback
    private static final String FONT_FAMILY_STACK = "'Outfit', 'Noto Sans KR', 'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif";
        ...
        return String.format("""
                        ...
                        <svg width="350" height="170" viewBox="0 0 350 170" fill="none" role="img" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve">
                            ...
                            <style type="text/css">
                                ...
                                .diff-plus { fill: #4ADE80; font-weight: 700; font-size: 11px; font-family: 'JetBrains Mono', monospace; }
                                .diff-minus { fill: #FF6B6B; font-weight: 700; font-size: 11px; font-family: 'JetBrains Mono', monospace; }
                                ]]>
                            </style>
